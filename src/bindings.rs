...
pub const COLOR_GREEN: u32 = 4278255360;
pub const COLOR_BLUE: u32 = 4278190335;
pub const COLOR_RED: u32 = 4294901760;
pub const COLOR_YELLOW: u32 = 4294967040;
pub const COLOR_ORANGE: u32 = 4294919424;
pub const COLOR_BLACK: u32 = 4278190080;
pub const COLOR_WHITE: u32 = 4294967295;
...
#[test]
fn bindgen_test_layout_image_buffer_t() {
    const UNINIT: ::std::mem::MaybeUninit<image_buffer_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<image_buffer_t>(),
        40usize,
        concat!("Size of: ", stringify!(image_buffer_t))
    );
    assert_eq!(
        ::std::mem::align_of::<image_buffer_t>(),
        8usize,
        concat!("Alignment of ", stringify!(image_buffer_t))
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).width_stride) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(image_buffer_t),
            "::",
            stringify!(width_stride)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).height_stride) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(image_buffer_t),
            "::",
            stringify!(height_stride)
        )
    );
    assert_eq!(
...
#[test]
fn bindgen_test_layout_image_rect_t() {
    const UNINIT: ::std::mem::MaybeUninit<image_rect_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<image_rect_t>(),
        16usize,
        concat!("Size of: ", stringify!(image_rect_t))
    );
    assert_eq!(
        ::std::mem::align_of::<image_rect_t>(),
        4usize,
        concat!("Alignment of ", stringify!(image_rect_t))
    );
    assert_eq!(
...
extern "C" {
    ...
    pub fn read_data_from_file(
        ...
        out_data: *mut *mut ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct letterbox_t {
    pub x_pad: ::std::os::raw::c_int,
    pub y_pad: ::std::os::raw::c_int,
    pub scale: f32,
}
#[test]
fn bindgen_test_layout_letterbox_t() {
    const UNINIT: ::std::mem::MaybeUninit<letterbox_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<letterbox_t>(),
        12usize,
        concat!("Size of: ", stringify!(letterbox_t))
    );
    assert_eq!(
        ::std::mem::align_of::<letterbox_t>(),
        4usize,
        concat!("Alignment of ", stringify!(letterbox_t))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).x_pad) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(letterbox_t),
            "::",
            stringify!(x_pad)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).y_pad) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(letterbox_t),
...
extern "C" {
    #[doc = " @brief Write image file (support jpg/png)\n\n @param path [in] Image path\n @param image [in] Image for write (only support IMAGE_FORMAT_RGB888)\n @return int 0: success; -1: error"]
    pub fn write_image(
        path: *const ::std::os::raw::c_char,
        image: *const image_buffer_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " @brief Convert image for resize and pixel format change\n\n @param src_image [in] Source Image\n @param dst_image [out] Target Image\n @param src_box [in] Crop rectangle on source image\n @param dst_box [in] Crop rectangle on target image\n @param color [in] Pading color if dst_box can not fill target image\n @return int"]
    pub fn convert_image(
        src_image: *mut image_buffer_t,
        dst_image: *mut image_buffer_t,
        src_box: *mut image_rect_t,
        dst_box: *mut image_rect_t,
        color: ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " @brief Convert image with letterbox\n\n @param src_image [in] Source Image\n @param dst_image [out] Target Image\n @param letterbox [out] Letterbox\n @param color [in] Fill color on target image\n @return int"]
    pub fn convert_image_with_letterbox(
        src_image: *mut image_buffer_t,
        dst_image: *mut image_buffer_t,
        letterbox: *mut letterbox_t,
        color: ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " @brief Get the image size\n\n @param image [in] Image\n @return int image size"]
    pub fn get_image_size(image: *mut image_buffer_t) -> ::std::os::raw::c_int;
}
